...
**Proficient:** SQL (PostgreSQL), Linux/Bash Scripting, Docker, Git/GitHub, Database Design (DDL/DML), Crontab/Automation

**Competent:** Python, C++, JavaScript, Google Cloud Platform (GCP), HTML/CSS, Java

**Familiar:** MongoDB, React, Tableau, JSON/YAML, Jira
